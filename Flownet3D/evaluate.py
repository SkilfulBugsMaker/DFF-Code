...
def eval_one_epoch(sess, ops):
    ...
    log_string('DATALEN = %d' % len(TEST_DATASET))
    begin = time.time()
    ...
    log_string('eval %d cost %f seconds, %f' % (len(TEST_DATASET), end-begin, (end-begin)/len(TEST_DATASET)))
